...
function pokemonFunction(pokemonName,pokemonGame)
{
    ...
    for(var x=0;x<pokemonGame.pokemon.length;x++)
        {
        var nameOfPokemon=pokemonGame.pokemon[x]["name"]
        if(nameOfPokemon==pokemonName)
        {
          pokemonDetail=pokemonGame.pokemon[x];
          console.log(pokemonDetail);
          alert(pokemonDetail+"  pokemon detail will be displayed on console");
          break;
        }
        }
}
