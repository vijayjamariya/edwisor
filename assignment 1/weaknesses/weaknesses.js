...
function pokemonFunction(pokemonWeakness,pokemonGame)
{
  var weakness;
  var nameOfPokemon;
  for(var x=0;x< pokemonGame.pokemon.length;x++)
  {
    for(y=0;y<pokemonGame.pokemon[x].weaknesses.length;y++)
    {
      weakness=pokemonGame.pokemon[x].weaknesses[y];
      if(weakness==pokemonWeakness)
      {
          nameOfPokemon=pokemonGame.pokemon[x].name;
          alert(nameOfPokemon);
      }
    }
  }
...
var pokemonWeakness=window.prompt("enter any weakness of pokemon ")

pokemonFunction(pokemonWeakness,pokemonGame);
