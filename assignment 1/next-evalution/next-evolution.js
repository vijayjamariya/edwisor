...
function pokemonFunction(pokemonName,pokemonGame)
{
for(var x=0;x<pokemonGame.pokemon.length;x++)
{
  var searchPokemon=pokemonGame.pokemon[x].name;
  if(searchPokemon==pokemonName)
  {
    for(var y=0;y<pokemonGame.pokemon[x].next_evolution.length ; y++)
    {
      var evolution=pokemonGame.pokemon[x].next_evolution[y].name;
      alert(evolution);
  }
}
...
pokemonFunction(pokemonName,pokemonGame);
